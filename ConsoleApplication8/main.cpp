...
int main()
{
    ...
    Archer archer1("Bob", 100, 20, 200, &Bow1);
    SwordMan swordman1("Rex4", 100, 10, &Sword1);
    SwordMan swordman2("Rex1", 100, 20, &Sword1);
    SwordMan swordman3("Rex2", 100, 30, &Sword1);
    SwordMan swordman4("Rex3", 100, 40, &Sword1);
